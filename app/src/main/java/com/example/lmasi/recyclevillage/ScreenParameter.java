...
public class ScreenParameter {
    ...
    //default screen size
    private static double DEFAULTSIZE_Y = 2560.0;
    private static double DEFAULTSIZE_X = 1440.0;

    //screenparameter to be used
    private static double  screenparam_x = 1;
    private static double  screenparam_y = 1;
    private static double  screen_x = 1440;
    private static double  screen_y = 2560.;
